...
parser.add_argument("--profiling", default='./profiling', help='profiling directory')
...
def main():
    ...
    print("Data loading...")
    validation = dataLoad(plat=args.platform, dataset='imagenet')
    ...
    if args.platform=='tensorflow':
        ...
        model.predict(validation, steps=args.steps, callbacks=[customHistory], workers=args.workers, verbose=1)
